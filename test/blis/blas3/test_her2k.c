		  ...
		  obj_t *C )
{
  ...
  dim_t dimLen4, bs4, idx4;
	...
	bli_acquire_mpart_l2r( BLIS_SUBPART1,
			       offL, nL, &packed_B_pan, &packed_B_pan_L );
	bli_packm_blk_var2( &BLIS_ONE, &B_B_1_1, &packed_A_blk );
	bli_herk_l_ker_var2( &BLIS_ONE, &packed_A_blk, &packed_B_pan_L, 
			     &BLIS_ONE, &C_1_B_1_L, (herk_t*)NULL );
		  ...
		  obj_t *C )
{
  ...
  dim_t dimLen4, bs4, idx4;
	...
	bli_acquire_mpart_l2r( BLIS_SUBPART1,
			       offR, nR, &packed_B_pan, &packed_B_pan_R );
	bli_packm_blk_var2( &BLIS_ONE, &B_T_1_1, &packed_A_blk );
	bli_herk_u_ker_var2( &BLIS_ONE, &packed_A_blk, &packed_B_pan_R, 
			     &BLIS_ONE, &C_1_T_1_R, (herk_t*)NULL );
		  ...
		  obj_t *C )
{
  ...
  dim_t dimLen4, bs4, idx4;
	...
	bli_acquire_mpart_l2r( BLIS_SUBPART1,
			       offL, nL, &packed_B_pan, &packed_B_pan_L );
	bli_packm_blk_var2( &BLIS_ONE, &BT_B_1_1, &packed_A_blk );
	bli_herk_l_ker_var2( &BLIS_ONE, &packed_A_blk, &packed_B_pan_L, 
			     &BLIS_ONE, &C_1_B_1_L, (herk_t*)NULL );
	...
	bli_acquire_mpart_l2r( BLIS_SUBPART1,
			       offL, nL, &packed_B_pan, &packed_B_pan_L );
	bli_packm_blk_var2( &BLIS_ONE, &AT_B_1_1, &packed_A_blk );
	bli_herk_l_ker_var2( &BLIS_ONE, &packed_A_blk, &packed_B_pan_L, 
			     &BLIS_ONE, &C_1_B_1_L, (herk_t*)NULL );
		  ...
		  obj_t *C )
{
  ...
  for ( idx1 = 0; idx1 < dimLen1; idx1 += bs1 ) {
	...
	bli_acquire_mpart_l2r( BLIS_SUBPART1,
			       offR, nR, &packed_B_pan, &packed_B_pan_R );
	bli_packm_blk_var2( &BLIS_ONE, &BT_T_1_1, &packed_A_blk );
	bli_herk_u_ker_var2( &BLIS_ONE, &packed_A_blk, &packed_B_pan_R, 
			     &BLIS_ONE, &C_1_T_1_R, (herk_t*)NULL );
	...
	bli_acquire_mpart_l2r( BLIS_SUBPART1,
			       offR, nR, &packed_B_pan, &packed_B_pan_R );
	bli_packm_blk_var2( &BLIS_ONE, &AT_T_1_1, &packed_A_blk );
	bli_herk_u_ker_var2( &BLIS_ONE, &packed_A_blk, &packed_B_pan_R, 
			     &BLIS_ONE, &C_1_T_1_R, (herk_t*)NULL );

...
///// Blocksize = 256
 ...
 for ( idx1 = 0; idx1 < dimLen1; idx1 += bs1 ) {
   bs1 = bli_determine_blocksize_b( idx1, dimLen1, C, gemm_kc );
...
//****
	...
	obj_t C_1;
	bli_acquire_mpart_b2t( BLIS_SUBPART1, idx1, bs1, C, &C_1 );
	obj_t C_2;
	bli_acquire_mpart_b2t( BLIS_SUBPART2, idx1, bs1, C, &C_2 );
	//------------------------------------//

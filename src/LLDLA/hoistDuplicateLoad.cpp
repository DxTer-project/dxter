...
bool HoistDuplicateLoad::OnlyFoundLoad(const LoopTunnel* setTunIn) const {
...
bool HoistDuplicateLoad::PossChildrenAreOnlyLoads(const LoopTunnel* possTunIn) const {
...
bool HoistDuplicateLoad::CanApply(const Node *node) const
{
...
void HoistDuplicateLoad::RemoveLoadsFromPosses(LoopTunnel* setTunIn) const {
...
void HoistDuplicateLoad::AddOneOuterLoad(LoopTunnel* setTunIn) const {
  auto newLoad = new DuplicateRegLoad();

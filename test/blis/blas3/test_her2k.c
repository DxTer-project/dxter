		  ...
		  obj_t *C )
{
  ...
  obj_t B_1T_packed;
    ...
    bli_obj_init_pack( &B_1_1_packed );
...
//****
	...
	//****
		...
		bli_acquire_mpart_l2r( BLIS_SUBPART1,
				offL, nL, &C_1, &C_1L );
				bli_acquire_mpart_l2r( BLIS_SUBPART1,
				offL, nL, &B_1T_packed, &B_1T_packedL );
		bli_packm_blk_var2( &BLIS_ONE, &A_1_1, &A_1_1_packed );
		bli_herk_l_ker_var2( &BLIS_ONE, &A_1_1_packed, &B_1T_packedL, 
	...
	//****
		...
		bli_packm_blk_var2( &BLIS_ONE, &B_1_1, &B_1_1_packed );
		bli_herk_l_ker_var2( &BLIS_ONE, &B_1_1_packed, &A_1T_packedL, 
				&BLIS_ONE, &C_1L, (herk_t*)NULL );
...
//****
    ...
    bli_obj_release_pack( &B_1_1_packed );
...
//****
	...
	//****
		...
		obj_t C_1R, B_1T_packedR;
		dim_t offR = bli_max( 0, bli_obj_diag_offset_after_trans( C_1 ) );
		dim_t nR = bli_obj_width_after_trans( C_1 ) - offR;
		bli_acquire_mpart_l2r( BLIS_SUBPART1,
				offR, nR, &C_1, &C_1R );
				bli_acquire_mpart_l2r( BLIS_SUBPART1,
				offR, nR, &B_1T_packed, &B_1T_packedR );
		bli_packm_blk_var2( &BLIS_ONE, &A_1_1, &A_1_1_packed );
		bli_herk_u_ker_var2( &BLIS_ONE, &A_1_1_packed, &B_1T_packedR, 
	...
	//****
		...
		bli_packm_blk_var2( &BLIS_ONE, &B_1_1, &B_1_1_packed );
		bli_herk_u_ker_var2( &BLIS_ONE, &B_1_1_packed, &A_1T_packedR, 
				&BLIS_ONE, &C_1R, (herk_t*)NULL );
...
void DxT_Her2kTL( obj_t *alpha,
		  ...
		  obj_t *C )
{
  obj_t B_1_packed, A_1_packed;
  obj_t A_1T_1_packed, B_1T_1_packed;
    bli_obj_init_pack( &B_1_packed );
    bli_obj_init_pack( &A_1_packed );
    bli_obj_init_pack( &A_1T_1_packed );
    bli_obj_init_pack( &B_1T_1_packed );
...
//****
	...
	//****
		...
		bli_acquire_mpart_l2r( BLIS_SUBPART1,
				offL, nL, &C_1, &C_1L );
				bli_acquire_mpart_l2r( BLIS_SUBPART1,
				offL, nL, &B_1_packed, &B_1_packedL );
		bli_packm_blk_var2( &BLIS_ONE, &A_1T_1, &A_1T_1_packed );
		bli_herk_l_ker_var2( &BLIS_ONE, &A_1T_1_packed, &B_1_packedL, 
				&BLIS_ONE, &C_1L, (herk_t*)NULL );
	...
	//****
		obj_t B_1T_1;
		bli_acquire_mpart_b2t( BLIS_SUBPART1, idx2, bs2, &B_1T, &B_1T_1 );
		obj_t C_0;
		bli_acquire_mpart_b2t( BLIS_SUBPART0, idx2, bs2, C, &C_0 );
		obj_t C_1;
		bli_acquire_mpart_b2t( BLIS_SUBPART1, idx2, bs2, C, &C_1 );
		...
		bli_packm_blk_var2( &BLIS_ONE, &B_1T_1, &B_1T_1_packed );
		bli_herk_l_ker_var2( &BLIS_ONE, &B_1T_1_packed, &A_1_packedL, 
				&BLIS_ONE, &C_1L, (herk_t*)NULL );
...
//****
    ...
    bli_obj_release_pack( &B_1T_1_packed );
}
...
//****
	...
	//****
		...
		bli_obj_set_struc( BLIS_SYMMETRIC, C_1 );
		bli_obj_set_uplo( BLIS_UPPER, C_1 );
		obj_t C_1R, B_1_packedR;
		dim_t offR = bli_max( 0, bli_obj_diag_offset_after_trans( C_1 ) );
		dim_t nR = bli_obj_width_after_trans( C_1 ) - offR;
		bli_acquire_mpart_l2r( BLIS_SUBPART1,
				offR, nR, &C_1, &C_1R );
				bli_acquire_mpart_l2r( BLIS_SUBPART1,
				offR, nR, &B_1_packed, &B_1_packedR );
		bli_packm_blk_var2( &BLIS_ONE, &A_1T_1, &A_1T_1_packed );
		bli_herk_u_ker_var2( &BLIS_ONE, &A_1T_1_packed, &B_1_packedR, 
				&BLIS_ONE, &C_1R, (herk_t*)NULL );
	...
	//****
		obj_t B_1T_1;
		bli_acquire_mpart_t2b( BLIS_SUBPART1, idx2, bs2, &B_1T, &B_1T_1 );
		obj_t C_1;
		bli_acquire_mpart_t2b( BLIS_SUBPART1, idx2, bs2, C, &C_1 );
		obj_t C_2;
		bli_acquire_mpart_t2b( BLIS_SUBPART2, idx2, bs2, C, &C_2 );
		...
		bli_packm_blk_var2( &BLIS_ONE, &B_1T_1, &B_1T_1_packed );
		bli_herk_u_ker_var2( &BLIS_ONE, &B_1T_1_packed, &A_1_packedR, 
				&BLIS_ONE, &C_1R, (herk_t*)NULL );
